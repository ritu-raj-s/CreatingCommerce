...
function addLineItem(
    ...
    productLineItem.custom.addedByName = addByName;
 ...
 */
function addProductToCart(currentBasket, productId, quantity, childProducts, options, addByName) {
    var availableToSell;
    ...
    if (productInCart) {
        ...
        if (addByName) {
            productInCart.custom.addedByName = addByName;
        }
